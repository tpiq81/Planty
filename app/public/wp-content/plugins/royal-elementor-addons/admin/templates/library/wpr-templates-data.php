		...
		return [
			'grocery-store' => [
				'v1' => [
					...
					'tags' => 'grocery store shop shopping woo-commerce woocommerce estore ecommerce product online eshopping market reseller ecommerce shop organic food natural e commerce',
					'theme-builder' => false,
					'woo-builder' => true,
					'off-canvas' => false,
			...
			'realestate' => [
				...
				'v3' => [
					...
					'plugins' => '{}',
					'tags' => 'real estate agency company property rentals estate sales developers construction agency property rentals sales property agent flat homes rent sale listing realtor broker acf dynamic',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => true,
					'price' => $is_pro_active ? 'free' : 'pro',
